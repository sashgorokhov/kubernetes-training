...
kubectl config --kubeconfig /vagrant/kubernetes/kubeconfig set-cluster local --server https://master1.example.com --certificate-authority /etc/kubernetes/shared/ssl/ca.pem
